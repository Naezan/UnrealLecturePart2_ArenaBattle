...
AABCharacterPlayer::AABCharacterPlayer()
{
	...
	//스프링 암의 길이입니다. 간단하게 플레이어와 카메라와의 거리라고 생각하면 편합니다.
	CameraBoom->TargetArmLength = 400.0f;
	//컨트롤러의 회전방향에 따라 움직이도록 합니다.
	CameraBoom->bUsePawnControlRotation = true;

	FollowCamera = CreateDefaultSubobject<UCameraComponent>(TEXT("FollowCamera"));
	//카메라를 스프링암의 끝에 붙여 줍니다.
	FollowCamera->SetupAttachment(CameraBoom, USpringArmComponent::SocketName);
	//컨트롤러의 회전방향에 따라 움직이지 않도록 합니다.
	...
	static ConstructorHelpers::FObjectFinder<UInputAction> AttackActionControlRef(TEXT("/Script/EnhancedInput.InputAction'/Game/ArenaBattle/Input/Actions/IA_Attack.IA_Attack'"));
	if (nullptr != AttackActionControlRef.Object)
	{
		AttackAction = AttackActionControlRef.Object;
	}
